package kw.hive.hooks;

import kw.hive.hooks.model.*;
import kw.hive.hooks.model.event.*;
...
public class LineageHook  implements ExecuteWithHookContext {
    ...
    public void run(HookContext hookContext) throws Exception {
        ...
        try {
            ...
            System.out.println("Hive hook " + hookType + " , operation name " + operationName);
            ...
            System.out.println("Hive hook this session optionname is " + hiveOperation);
