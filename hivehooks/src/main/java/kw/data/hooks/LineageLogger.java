...
//     */
//    private List<Edge> getEdges(QueryPlan plan, LineageCtx.Index index) {
//        LinkedHashMap<String, ObjectPair<SelectOperator,
//                org.apache.hadoop.hive.ql.metadata.Table>> finalOps = index.getFinalSelectOps();
//
...
//                org.apache.hadoop.hive.ql.metadata.Table> pair : finalOps.values()) {
