package com.data.lineage.parse;

import com.data.lineage.bean.Block;
import com.data.lineage.bean.ColLine;
import com.data.lineage.bean.QueryTree;
import com.data.lineage.bean.SQLResult;
import com.data.lineage.exception.SQLParseException;
import com.data.lineage.exception.UnSupportedException;
import com.data.lineage.util.*;
...
//		}
    ...
    private void setColLineList() {
        ...
        for (Map.Entry<String, List<ColLine>> entry : resultQueryMap.entrySet()) {
        ...
        for (Map.Entry<String, List<ColLine>> entry : map.entrySet()) {
