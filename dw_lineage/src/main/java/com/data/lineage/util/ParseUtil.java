...
import com.data.lineage.bean.DWTask;
import com.data.lineage.exception.SQLExtractException;

import java.util.*;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static com.data.lineage.util.FileUtil.read;

/**
 * @author yangfei
 * @create 2020-06-19 14:49
 * 解析工具类
 */
public final class ParseUtil {
    ...
    private static String getVarValue(String content, String _var) {
        String value = null;
        for (Map.Entry<String, Boolean> entry : REGEX_MULTI_VAR_VALUE.entrySet()) {
