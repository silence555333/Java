...
public class DWSFlow implements Flow {
    ...
    private List<com.webank.wedatasphere.dss.common.entity.flow.DWSFlow> children;
    ...
    @Override
    public List<? extends com.webank.wedatasphere.dss.common.entity.flow.DWSFlow> getChildren() {
        return children;
    }

    @Override
    public void setChildren(List<? extends Flow> children) {
        this.children = children.stream().map(f ->(com.webank.wedatasphere.dss.common.entity.flow.DWSFlow)f).collect(Collectors.toList());
    }
